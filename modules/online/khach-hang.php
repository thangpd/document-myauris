            ...
            <div class="uk-grid-large" data-uk-grid>
                ...
                <div class="uk-width-1-1 uk-width-expand@m">
                    <article class="uk-article">
                        <h1 class="uk-article-title">Khách Hàng</h1>
                        <p class="uk-text-lead uk-text-muted">Hiển thị danh sách dữ liệu khách hàng, các chức năng thao
                            tác với dữ liệu.</p>
                        ...
                        <div class="article-content link-primary">
                            <figure data-uk-lightbox="animation: slide">
                                <a class="uk-inline" href="<?php echo $home_url ?>modules/images/online/index.png"
                                   data-caption="Trang chủ">
                                    <img src="<?php echo $home_url ?>modules/images/online/index.png" alt="Trang chủ">
                                    <div class="uk-position-center">
                                        <span data-uk-overlay-icon></span>
                                    </div>
                                </a>
                                <figcaption data-uk-grid class="uk-flex-right uk-grid uk-grid-stack"><span
                                            class="uk-width-auto uk-first-column">Hình ảnh trang khách hàng</span>
                                </figcaption>
                            </figure>
                            <ol>
                                <li>10 khách vừa đến gần nhất.</li>
                            </ol>
                            <p>Dữ liệu sẽ được nhân viên tư vấn online nhập. Xem <a href="<?php echo $home_url ?>modules/thao-tac/online-nhap-kh.php">cách nhập dữ liệu khách
                                    hàng</a>.</p>
