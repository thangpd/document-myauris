...
<!--            <li><a href="--><?php //echo $home_url ?><!--modules/screen/danh-gia.php">Đánh Giá</a></li>-->
        ...
        <h5>Chi</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/chi/danh-muc-chi.php">Danh Mục Chi</a></li>
        ...
        <h5>Online</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/online/khach-hang-cu.php">Khách Hàng Cũ</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/khach-hang.php">Khách Hàng</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/nhac-lich.php">Nhắc Lịch</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/affiliate.php">Affiliate</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/dat-lich.php">Đặt Lịch</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/gui-sms.php">Gửi SMS</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/token-khach-hang.php">Token Khách Hàng</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/feedback-khach-hang.php">Feedback Khách Hàng</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/dich-vu.php">Dịch Vụ</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/nhap-pancake.php">Nhập Pancake</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/nhap-tuong-tac.php">Nhập Tương Tác</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/nguon-khach-hang.php">Nguồn Khách Hàng</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/fanpage.php">Agency</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/nhom-tinh-cach.php">Nhóm Tích Cách</a></li>
            <li><a href="<?php echo $home_url ?>modules/online/trang-thai-fail.php">Trạng Thái Fail</a></li>
        ...
        <ul class="uk-nav uk-nav-default doc-nav">
            ...
            <li><a href="<?php echo $home_url ?>modules/lich-kham/khach-hang.php">Khách Hàng</a></li>
        </ul>
        <h5>Affiliate</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/affiliate/mau-trang-landing.php">Mẫu Trang Landing</a></li>
            <li><a href="<?php echo $home_url ?>modules/affiliate/supports.php">Supports</a></li>
            <li><a href="<?php echo $home_url ?>modules/affiliate/khach-hang.php">Khách Hàng</a></li>
        </ul>
        <h5>General</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/general/thong-bao.php">Thông Báo</a></li>
            <li><a href="<?php echo $home_url ?>modules/general/danh-ba.php">Danh Bạ</a></li>
        </ul>
        <h5>Quản Lý File</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/general/quan-ly-file.php">Quản Lý File</a></li>
        </ul>
        <h5>Nhân Viên</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/nhanvien/nhanvien.php">Nhân Viên</a></li>
            <li><a href="<?php echo $home_url ?>modules/nhanvien/phan-quyen.php">Phân Quyền</a></li>
            <li><a href="<?php echo $home_url ?>modules/nhanvien/permission.php">Permission</a></li>
        </ul>
        <h5>Log</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/log/vht-call-log.php">Vht Call Log</a></li>
            <li><a href="<?php echo $home_url ?>modules/log/system-log.php">System Log</a></li>
            <li><a href="<?php echo $home_url ?>modules/log/sms-log.php">SMS Log</a></li>
        </ul>
        <h5>Địa Danh</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/dia-danh/dia-danh.php">Địa Danh</a></li>
            <li><a href="<?php echo $home_url ?>modules/dia-danh/phuong-xa.php">Phường/Xã</a></li>
            <li><a href="<?php echo $home_url ?>modules/dia-danh/quan-huyen.php">Quận/Huyện</a></li>
            <li><a href="<?php echo $home_url ?>modules/dia-danh/tinh-thanh.php">Tỉnh Thành</a></li>
            <li><a href="<?php echo $home_url ?>modules/dia-danh/quoc-gia.php">Quốc Gia</a></li>
        </ul>
        <h5>Event Source</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/event-source/khach-danh-gia.php">Khách Đánh Giá</a></li>
        </ul>
        <h5>Cài Đặt</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/cai-dat/cau-hinh.php">Cấu Hình</a></li>
            <li><a href="<?php echo $home_url ?>modules/cai-dat/key-value.php">Key-Value</a></li>
            <li><a href="<?php echo $home_url ?>modules/cai-dat/co-so.php">Cơ Sở</a></li>
            <li><a href="<?php echo $home_url ?>modules/cai-dat/cai-dat-sms.php">Cài Đặt Sms</a></li>
        </ul>
        <h5>Hỗ Trợ</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/ho-tro/dat-cau-hoi.php">Đặt Câu Hỏi</a></li>
            <li><a href="<?php echo $home_url ?>modules/ho-tro/danh-muc.php">Danh Mục</a></li>
            <li><a href="<?php echo $home_url ?>modules/ho-tro/general.php">General</a></li>
            <li><a href="<?php echo $home_url ?>modules/ho-tro/phong-kham.php">Phòng Khám</a></li>
            <li><a href="<?php echo $home_url ?>modules/ho-tro/sales-online.php">Sales Online</a></li>
        </ul>
        <h5>Tester</h5>
        <ul class="uk-nav uk-nav-default doc-nav">
            <li><a href="<?php echo $home_url ?>modules/tester/google-driver-api.php">Google Driver Api</a></li>
            <li><a href="<?php echo $home_url ?>modules/tester/png-tree.php">Png Tree</a></li>
        </ul>
    </div>
</div>
